...
excerpt: Một Full-stack Developer phải sử dụng linh hoạt cả Front-end và Back-end để xây dựng được một ứng dụng hoặc một trang web hoàn chỉnh. Dưới đây là lộ trình đầy đủ cho Full-stack developer.
...
<Figure
  ...
  caption="Nguồn: https://roadmap.sh/frontend"
/>
...
<Figure
  ...
  caption="Nguồn: https://roadmap.sh/backend"
/>
...
## VII. Học cách triển khai ứng dụng, chẳng hạn như trên AWS hoặc Heroku
