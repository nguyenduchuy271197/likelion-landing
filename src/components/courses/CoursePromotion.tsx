  ...
  return (
    <div>
      <div className="container">
        <div className="flex flex-col items-center max-w-screen-xl gap-6 m-auto lg:flex-row lg:gap-0">
          ...
          <ul className="lg:basis-[750px]">
            {promotions.map((promotion) => (
              <li className="relative py-2 sm:py-6 group" key={promotion}>
                ...
                <div className="flex items-center gap-6">
                  <div className="relative mb-4 lg:mb-0 lg:pl-16">
                    ...
                    <div className="relative grid w-12 h-12 border border-solid rounded-full sm:h-24 sm:w-24 border-primary-500 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
                      <Gift
                        className="block w-full h-full m-auto max-h-6 sm:max-h-12 text-muted"
                        strokeWidth={1}
                      />
                    </div>
                  </div>
